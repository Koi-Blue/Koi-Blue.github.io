[![image.png](https://i.postimg.cc/gJfqFRNC/image.png)](https://postimg.cc/MMmj1ck5)
...
**自主存取控制（DAC）：** 由資源擁有者決定誰可以訪問，權限較為靈活。例如：Windows文件權限、SQL中的 ` GRANT ` 命令；
**強制存取控制（MAC）：** 由系統根據預設安全策略強制控制，無法更改。例如：SELinux、Windows的安全性標籤；
**區別：** DAC由使用者決定權限，MAC由系統控制、安全性較高但不靈活。
...
关于范式的部分，推荐读[这篇博客](https://blog.csdn.net/weixin_43954951/article/details/125494783)
或[这一篇博客](https://cloud.tencent.com/developer/article/2055118)
...
$\qquad$其中**加粗**为主键，<mark>高亮</mark>为外键。
